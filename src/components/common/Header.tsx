      ...
      <div className="max-w-7xl mx-auto flex h-20 items-center justify-between px-4 sm:px-8 relative">
        ...
        >
          <div className="relative flex items-center justify-center">
            {/* Glow Pulse Aura (100% Tailwind v4) */}
            <div className="absolute inset-0 rounded-xl bg-primary/40 blur-md animate-pulse pointer-events-none" />

            {/* Squircle Isotipo */}
            <div className="relative w-10 h-10 rounded-xl bg-primary text-primary-foreground flex items-center justify-center shadow-md shadow-primary/20 group-hover:scale-105 transition-transform duration-200">
